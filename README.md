...
As the equation is of the form y = ax<sup>b</sup>, a log transform in both genome size and virion volume facilitates fitting a linear model. This can be shown by the following algebraic steps:
...
Plugging *300kb* into the equation V = αL<sup>β</sup> gives **6697006nm<sup>3</sup>** as the size of the host virion, assuming accurate values of α and β generated by the linear model.
